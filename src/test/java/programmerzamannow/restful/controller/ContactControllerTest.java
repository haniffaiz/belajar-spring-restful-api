...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertEquals("Hanif",response.getData().getFirstName());
            assertEquals("Hidayat",response.getData().getLastName());
            assertEquals("hanif@example.com",response.getData().getEmail());
            assertEquals("0811",response.getData().getPhone());
    ...
    void getContactSuccess() throws Exception {
        ...
        contact.setFirstName("Hanif");
        contact.setLastName("Hidayat");
        contact.setEmail("hanif@example.com");
        contact.setPhone("0811");
